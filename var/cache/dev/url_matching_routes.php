...
return [
    ...
    [ // $dynamicRoutes
        ...
        190 => [[['_route' => 'reclamer_show', '_controller' => 'App\\Controller\\ReclamerController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        203 => [[['_route' => 'reclamer_edit', '_controller' => 'App\\Controller\\ReclamerController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        211 => [
